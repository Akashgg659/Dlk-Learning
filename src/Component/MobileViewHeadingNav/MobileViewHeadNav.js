...
import '../Css/MobileViewHeadNav.css'
...
const MobileViewHeadNav = () => {
  ...
  <input type="checkbox" id="active"  className=''
  onClick={() => setIsSidebarOpen(true)}></input>
  ...
  <div className="wrapper  ">
   ...
   <div className=' e'>
      ...
      <div className='  border cardheight3 scrollable-container'>
    
    <div className=' me-3 ms-3 d-flex text-center '>
      <img src='/images/python.png' className='img-fluid p-2 ' width={80}  ></img>
    ...
    <Link to={"/python"}   
      ...
      onClick={handleLinkClick} >
       ...
       <Link to={"/python/numberspage"} className="n text-black"
        ...
        <Link to={"/python/literal"} className="dropdown-item n text-black" 
         onClick={handleLinkClick} >
        ...
        <Link to={"/python/Bitwise"} className="dropdown-item n"
         onClick={handleLinkClick}  >
        <h5 className=' times-roman-text  p-2 hav '>Bitwise Operator</h5>
          ...
          <Link to={"/python/membership"} className="dropdown-item n " 
           onClick={handleLinkClick} >
        ...
        <Link to ={"/python/identity"} className='dropdown-item n '
         onClick={handleLinkClick} >
        <h5 className=' times-roman-text  p-2 hav '>Identity Operators</h5>
          ...
          <Link to={"/python/precedence"} className="dropdown-item n "
           onClick={handleLinkClick}  >
...
export default MobileViewHeadNav
...
<div class="section_our_solution ">
  ...
  <div className='row'>
    ...
    <div class="our_solution_category   
     "
     >
        <div class="solution_cards_box zoom-in-down
         "  data-aos="zoom-in-down"
          ...
          <div class="solution_card">
            ...
            <div class="so_top_icon">
              ...
              <img src='/images/sql.jpg'  className='img-fluid  '  ></img>
              
            </div>
            <div class="solu_title">
              <h3 className='ms-2'>SQL</h3>
            </div>
            <div class="solu_description ms-2">
              <p className='solu_title1'>
              SQL (Structured Query Language) is a standard language for managing and manipulating data in relational databases.
              </p>
              <button type="button" class="read_more_btn">Start Learn</button>
            </div>
          </div>
         ...
         "  data-aos="zoom-in-down"
          ...
          <div class="solution_card">
            ...
            <div class="so_top_icon">
              ...
              <img src='/images/php.jpg'  className='img-fluid  '  ></img>
              
            </div>
            <div class="solu_title">
              <h3 className='ms-2'>PHP</h3>
            </div>
            <div class="solu_description ms-2">
              <p className='solu_title1'>
              PHP (Hypertext Preprocessor) is a popular server-side scripting language used to create dynamic web applications.
              </p>
              <button type="button" class="read_more_btn">Start Learn</button>
            </div>
          </div>
         ...
         "  data-aos="zoom-in-down"
          ...
          <div class="solution_card">
            ...
            <div class="so_top_icon">
              ...
              <img src='/images/embedded.jpg'  className='img-fluid  '  ></img>
              
            </div>
            <div class="solu_title">
              <h3 className='ms-2'>Embedded</h3>
            </div>
            <div class="solu_description ms-2">
              <p className='solu_title1'>
         ...
         "  data-aos="zoom-in-down"
          ...
          <div class="solution_card">
            ...
            <div class="so_top_icon">
              ...
              <img src='/images/c.png'  className='img-fluid  '  ></img>
              
            </div>
            <div class="solu_title">
              <h3 className='ms-2'>C++</h3>
            </div>
            <div class="solu_description ms-2">
              <p className='solu_title1'>
              C++ is a high-performance, object-oriented programming language used for system/software development
              </p>
              <button type="button" class="read_more_btn">Start Learn</button>
            </div>
          </div>
         ...
         "  data-aos="zoom-in-up"
          ...
          <div class="solution_card">
            ...
            <div class="so_top_icon">
              ...
              <img src='/images/boot.png'  className='img-fluid  '  ></img>
              
            </div>
            <div class="solu_title">
              <h3 className='ms-2'>Bootstrap</h3>
              
            </div>
            <div class="solu_description ms-2">
              <p className='solu_title1'>
              Bootstrap is a popular open-source front-end framework for developing responsive and mobile-first websites</p>
              <button type="button" class="read_more_btn">Start Learn</button>
            </div>
          </div>
         ...
         "  data-aos="zoom-in-up"
          ...
          <div class="solution_card">
            ...
            <div class="so_top_icon">
              ...
              <img src='/images/js.png'  className='img-fluid  '  ></img>
              
            </div>
            <div class="solu_title">
              <h3 className='ms-2'>JavaScript</h3>
            </div>
            <div class="solu_description ms-2">
              <p className='solu_title1'>
              JavaScript is a versatile, high-level programming language primarily used for creating interactive  on websites. 
              </p>
              <button type="button" class="read_more_btn">Start Learn</button>
            </div>
          </div>
         ...
         "  data-aos="zoom-in-up"
          ...
          <div class="solution_card">
            ...
            <div class="so_top_icon">
              ...
              <img src='/images/mango.png'  className='img-fluid  '  ></img>
              
            </div>
            <div class="solu_title">
              <h3 className='ms-2'>MangoDB</h3>
            </div>
            <div class="solu_description ms-2">
              <p className='solu_title1'>
         ...
         "  data-aos="zoom-in-up"
          ...
          <div class="solution_card">
            ...
            <div class="so_top_icon">
              ...
              <img src='/images/react.png'  className='img-fluid  '  ></img>
              
            </div>
            <div class="solu_title">
              <h3 className='ms-2'>React</h3>
            </div>
            <div class="solu_description ms-2">
              <p className='solu_title1'>
              
            React is a popular JavaScript library used for building user interfaces, especially for single-page applications.
              </p>
              <button type="button" class="read_more_btn">Start Learn</button>
            </div>
          </div>
  ...
  /*
   ...
   <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 ">
      ...
      <div class="our_solution_category bg-secondary   ">
        <div class="solution_cards_box bg-warning ">
          <div class="solution_card">
            <div class="hover_color_bubble"></div>
            <div class="so_top_icon">
